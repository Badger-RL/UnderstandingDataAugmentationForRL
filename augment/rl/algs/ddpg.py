from typing import Any, Dict, Optional, Tuple, Type, Union, List, TypeVar
...
class DDPG(TD3):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            actor_data_source=actor_data_source,
            critic_data_source=critic_data_source,
            obs_active_layer_mask=obs_active_layer_mask,
            aug_active_layer_mask=aug_active_layer_mask,
            separate_aug_critic=separate_aug_critic,
            aug_freq=aug_freq,
