...
class FetchSlideAugmentationFunction(AugmentationFunction):
...
class FetchSlideHER(FetchSlideAugmentationFunction):
...
class FetchSlideTranslate(FetchSlideAugmentationFunction):
...
class FetchSlideReflect(FetchSlideAugmentationFunction):
