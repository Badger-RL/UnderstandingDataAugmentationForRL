...
class FetchPickAndPlaceAugmentationFunction(AugmentationFunction):
...
class FetchPickAndPlaceHER(FetchPickAndPlaceAugmentationFunction):
...
class FetchPickAndPlaceTranslate(FetchPickAndPlaceAugmentationFunction):
...
class FetchPickAndPlaceReflect(FetchPickAndPlaceAugmentationFunction):
