...
class FetchPushAugmentationFunction(AugmentationFunction):
...
class FetchPushHER(FetchPushAugmentationFunction):
...
class FetchPushReflect(FetchPushAugmentationFunction):
