...
from gym.envs.mujoco import InvertedDoublePendulumEnv as InvertedDoublePendulumEnv_original

class InvertedDoublePendulumEnv(InvertedDoublePendulumEnv_original):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def _get_obs(self):
        x_pos = self.sim.data.qpos[:1] if self.use_pos else [0]
