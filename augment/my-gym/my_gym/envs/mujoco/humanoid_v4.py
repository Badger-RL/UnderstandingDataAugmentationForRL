...
from gym.envs.mujoco.humanoid_v4 import HumanoidEnv as HumanoidEnv_original
...
class HumanoidEnv(HumanoidEnv_original):
    """
    ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(forward_reward_weight, ctrl_cost_weight, healthy_reward, terminate_when_unhealthy, healthy_z_range, reset_noise_scale, exclude_current_positions_from_observation, **kwargs)
